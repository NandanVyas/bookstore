...
const Mid = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Welcome to BookStore</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Online BookStore</p>
    </div>
    ...
    <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" control-id="ControlID-86">Button</button>
  </div>
</section>
    </div>
  )
